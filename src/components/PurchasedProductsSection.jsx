...
const PurchasedProductsSection = () => {
  ...
  const fetchOrderStats = async () => {
    try {
      const response = await fetch('https://tron-backend.vercel.app/api/orders/user/stats', {
  ...
  const fetchPurchasedProducts = async () => {
    ...
    try {
      const response = await fetch('https://tron-backend.vercel.app/api/users/purchased-products', {
        headers: getAuthHeaders(),
      });
